...
function smoothScrollToBottom() {
  ...
  function animate(currentTime) {
    ...
    const progress = Math.easeInOutQuad(
      timeElapsed,
      start,
      target - start,
      duration
    ...
    <form onSubmit={handleSubmit} className={"px-4"}>
      ...
      <div>
        ...
        <select
          className="form-input ml-4 px-2 py-2 rounded-full w-32"
          value={selectedName}
          onChange={makeHandleChangeEvent(setSelectedName)}
        >
          <option value="">---</option>
      ...
      <div className={"italic font-bold pb-4 pt-4"}>
        Click SUBMIT once summary is confirmed and submit images separately
      </div>
